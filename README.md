# team-34 Platanus Hack 26: CDMX Project
...
- José Zepeda Martínez ([@jose3450](https://github.com/jose3450))
- Enrique Diaz ([@cogitovsmachina](https://github.com/cogitovsmachina))
- Geovanni Zepeda Martínez ([@geovanni-zepeda](https://github.com/geovanni-zepeda))
- Angelo Luna ([@angeloluna](https://github.com/angeloluna))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-34.git
